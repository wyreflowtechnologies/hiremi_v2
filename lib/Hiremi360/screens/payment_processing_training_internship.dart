...
class PaymentProcessingTrainingInternship extends StatefulWidget {
  const PaymentProcessingTrainingInternship({super.key});

  @override
  State<PaymentProcessingTrainingInternship> createState() => _PaymentProcessingState();
}

class _PaymentProcessingState extends State<PaymentProcessingTrainingInternship>
  ...
  void initState() {
    ...
    Future.delayed(const Duration(seconds: 5), () {
      Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => PaymentFailedTrainingInternship(),
          ));
    });
  }
