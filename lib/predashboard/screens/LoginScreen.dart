...
//       });
//
//       Navigator.push(context,MaterialPageRoute(builder: (context)=> ProfileVerificationScreen1()));
//
//
...
//
//
//                   Image.asset('assets/images/enhancedlogo_3.png',
...
class _LoginScreenUpdatedState extends State<LoginScreenUpdated> {
  ...
  //           context,
  //           MaterialPageRoute(
  //             builder: (context) => HomeScreen(isVerified: responseData['is_verified'] ?? false),
  //           ),
  //         );
  //       } else {
  ...
  //         // Show error message
  //         ScaffoldMessenger.of(context).showSnackBar(
  //           SnackBar(content: Text(errorData['error'] ?? 'Login failed. Please try again.')),
  //         );
  //       }
  //     } catch (e) {
